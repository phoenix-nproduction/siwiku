...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    int sliderAllImages[]={R.drawable.screen1,R.drawable.screen2,R.drawable.screen3};
    int sliderAllTitle[]={R.string.screen1,R.string.screen2,R.string.screen3};
    int sliderAllDesc[]={R.string.descscreen1,R.string.descscreen2,R.string.descscreen3};
